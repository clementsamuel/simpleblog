		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					...
					<li><a href="<?php if (isset($_SESSION['id'])){echo'profile.php';}else{echo'login.php';}?>"><?php if(isset($_SESSION['id'])){echo $_SESSION['username'];}else{echo'Login';}?></a></li>
					<?php if(isset($_SESSION['id']))echo'<li><a href="logout.php">Logout</a></li>';?>
				</ul>
			</div><!--/.nav-collapse -->
		</div>
	</div> 
